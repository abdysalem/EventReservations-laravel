...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.rooms.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.rooms.update", [$room->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="name">{{ trans('cruds.rooms.fields.name') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.rooms.fields.name_helper') }}</span>
            </div>
            <div class="form-group">
