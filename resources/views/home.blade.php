                            ...
                            <div class="col-xl-3 col-lg-3 d-none d-lg-block">
                                <div class="buy_tkt">
                                    <div class="book_btn d-none d-lg-block">
                                        <a href="{{route('MakeReservations')}}">Make Reservations</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-xl-12">
                        <div class="slider_text text-center">
                            ...
                            <span class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".3s">On Every Monday</span>
                            <h3 class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".4s">Step Up Dance Concert</h3>
                            <p class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".5s">Sky Lounge, Conrad Hotel, Dubai</p>
                        </div>
                    </div>
                </div>
            </div>
